...
//        terminalA.Person tom = new terminalA.Person("Tom", 22, "Male");
//        terminalA.Person.nationality = "British";
//
//        try {
//            // serializable
//            ObjectOutputStream oout = new ObjectOutputStream(new FileOutputStream(file));
//            oout.writeObject(tom);
//            oout.close();
...
//        }
        ...
        try {
            ...
            terminalB.Person personTom = (terminalB.Person)oin.readObject();
            oin.close();
